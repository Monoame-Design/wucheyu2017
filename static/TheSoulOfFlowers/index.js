...
let themeNames = ['Twilight', 'Harvest', 'Mystic', 'Eclipse', 'Aurora', 'Meadow', 'Wonderland', 'Zenith', 'Oceanic']
let theme_id = Math.floor(random(0, themeNames.length))
let number_id = parseInt(random(0, 100000))
$fx.features({
  themeName: themeNames[theme_id],
  theme_id,
  number_id: parseInt(random(0, 100000)),
